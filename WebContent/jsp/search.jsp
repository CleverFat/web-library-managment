	...
	try{
	  ...
	  if(toSearch!=null){
		if(searchType.equals("1")){
		    ...
		    table.append("<table class='book-list'><thead class='black'><tr><th>isbn</th><th>封面</th><th>书名</th><th>作者</th><th>出版社</th><th>当前库存</th><th>总库存</th><th>借阅</th></tr></thead>");
			while(rs.next()) {
				table.append("<tr>");  
				...
				if(rs.getString("current_num")!="0")
				{
					table.append("<td><input type=\"button\" value=\"借阅\"  onclick=\"javascript:window.open('borrowBook.jsp?isbn="+rs.getString("isbn")+"')\"></td>");  
				}
				else
				{
					table.append("<td><input type=\"button\" value=\"借阅\" disabled=\"disabled\" ></td>"); 
				}
				table.append("</tr>");
			...
			while(rs.next()) {	
				...
				{
					table.append("<td><input type=\"button\" value=\"借阅\" disabled=\"disabled\" onclick=\"alert('你按下了按钮')\"></td>"); 
				}
				table.append("</tr>");
			}
			table.append("</table>");
                ...
                <div class="search-div">
                    ...
                    <div class="select-div">
                        检索方式：<%=msg%>&nbsp;
							...
							<input type="radio" name="search-type" value="1">ISBN&nbsp;
							<input type="radio" name="search-type" checked value="2">书名&nbsp;
							<input type="radio" name="search-type" value="3">作者
